...
(function(root,factory){
  ...
  function ensureStyles(){
    ...
    var s=D.createElement('style');s.id=STYLE_ID;s.textContent=[
      ...
      '.pcx-head{padding:14px 0 20px}.pcx-state-row{display:flex;align-items:center;gap:9px;min-height:25px}.pcx-stage{font:700 9px/1.2 "IBM Plex Mono",monospace;letter-spacing:.09em;text-transform:uppercase;color:#686761}.pcx-position{display:inline-flex;align-items:center;gap:6px;min-height:24px;border-radius:999px;background:var(--pci-green-soft);padding:0 10px;font-size:10px;font-weight:700;color:var(--pci-green)}.pcx-position i{width:6px;height:6px;border-radius:999px;background:currentColor}.pcx-name{margin:10px 0 0;font-family:"IBM Plex Sans",system-ui,sans-serif;font-size:38px;font-weight:720;letter-spacing:-.04em;line-height:1;text-transform:none}.pcx-contextline{margin-top:8px;font-size:11.5px;line-height:1.45;color:var(--pci-muted)}.pcx-contactline{display:flex;gap:6px 14px;flex-wrap:wrap;margin-top:8px;font-size:10.5px;color:var(--pci-faint)}.pcx-contactline a{color:inherit;text-decoration:none;border-bottom:1px solid rgba(23,23,22,.18)}.pcx-contactline a:hover{color:var(--pci-ink);border-bottom-color:var(--pci-ink)}',
      '.pcx-tabs{position:sticky;top:0;z-index:5;display:grid;grid-template-columns:1fr 1fr;border-bottom:1px solid var(--pci-line);background:rgba(255,254,250,.97);backdrop-filter:blur(14px)}.pcx-tab{position:relative;min-height:50px;appearance:none;border:0;background:transparent;padding:0;color:#96948e;font-size:12px;font-weight:650;cursor:pointer}.pcx-tab:after{content:"";position:absolute;left:22%;right:22%;bottom:-1px;height:2px;border-radius:999px;background:transparent}.pcx-tab.on{color:var(--pci-ink)}.pcx-tab.on:after{background:var(--pci-ink)}',
      ...
      '@media(max-width:620px){.drawer.pc-rail .sheet{padding:14px 18px 24px}.pcx-head{padding-top:8px}.pcx-name{font-size:34px}.pcx-tabs{margin:0 -2px}.pcx-current{margin-top:16px;padding:17px 16px}.pcx-current-sentence{font-size:18px}.pcx-facts{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:0 16px!important}.pcx-fact{padding:10px 0}.pcx-brief-row{grid-template-columns:92px minmax(0,1fr);gap:12px}.pcx-next{grid-template-columns:1fr;padding:15px}.pcx-next-action{grid-column:1;grid-row:auto;width:100%;margin-top:13px;min-height:44px}.pcx-detail-grid{grid-template-columns:1fr}.pcx-timeline{padding-left:20px}.pcx-timeline:before{left:4px}.pcx-milestone:before{left:-20px}}',
      '@media(max-width:390px){.pcx-facts{grid-template-columns:1fr!important}.pcx-name{font-size:31px}}',
