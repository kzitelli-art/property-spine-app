/* PROPERTY SPINE — PERSON × PROPERTY OVERVIEW v6
 *
...
(function(root,factory){
  ...
  var STYLE_ID='ps-person-card-information-v6';
  ...
  function eventKind(e){
    ...
    // A generic task or obligation being closed is not the relationship closing.
    // Only explicit relationship/commercial/lead closure truth may enter the timeline.
    var closureSignal=raw+'_'+source;
    if(/not_fit|withdraw/.test(raw)||/relationship.*clos|commercial.*clos|lead.*clos|prospect.*clos/.test(closureSignal)) return 'relationship_closed';
    if(/clos/.test(raw)) return 'operating_item_closed';
  ...
  function ensureStyles(){
    ...
    var s=D.createElement('style');s.id=STYLE_ID;s.textContent=[
      ...
      /* SPACING — the stretch from the name down to Relationship was mostly
         padding, not content. On a laptop that pushed the actual work below
         the fold, which is the opposite of a briefing. Everything below is a
         gap or a pad; the only type change is the name and the current-state
         sentence, both still comfortably large. Nothing was removed. */
      '.pcx-head{padding:10px 0 13px}.pcx-state-row{display:flex;align-items:center;gap:9px;min-height:22px}.pcx-stage{font:700 9px/1.2 "IBM Plex Mono",monospace;letter-spacing:.09em;text-transform:uppercase;color:#686761}.pcx-position{display:inline-flex;align-items:center;gap:6px;min-height:24px;border-radius:999px;background:var(--pci-green-soft);padding:0 10px;font-size:10px;font-weight:700;color:var(--pci-green)}.pcx-position i{width:6px;height:6px;border-radius:999px;background:currentColor}.pcx-name{margin:6px 0 0;font-family:"IBM Plex Sans",system-ui,sans-serif;font-size:32px;font-weight:720;letter-spacing:-.035em;line-height:1.02;text-transform:none}.pcx-contextline{margin-top:5px;font-size:11.5px;line-height:1.45;color:var(--pci-muted)}.pcx-contactline{display:flex;gap:4px 14px;flex-wrap:wrap;margin-top:5px;font-size:10.5px;color:var(--pci-faint)}.pcx-contactline a{color:inherit;text-decoration:none;border-bottom:1px solid rgba(23,23,22,.18)}.pcx-contactline a:hover{color:var(--pci-ink);border-bottom-color:var(--pci-ink)}',
      '.pcx-tabs{position:sticky;top:0;z-index:5;display:grid;grid-template-columns:1fr 1fr;border-bottom:1px solid var(--pci-line);background:rgba(255,254,250,.97);backdrop-filter:blur(14px)}.pcx-tab{position:relative;min-height:43px;appearance:none;border:0;background:transparent;padding:0;color:#96948e;font-size:12px;font-weight:650;cursor:pointer}.pcx-tab:after{content:"";position:absolute;left:22%;right:22%;bottom:-1px;height:2px;border-radius:999px;background:transparent}.pcx-tab.on{color:var(--pci-ink)}.pcx-tab.on:after{background:var(--pci-ink)}',
      '.pcx-panel{display:none}.pcx-panel.on{display:block}.pcx-info-stack{display:grid}.pcx-section-label{font:700 8.5px/1.2 "IBM Plex Mono",monospace;letter-spacing:.1em;text-transform:uppercase;color:#8f8d86}',
      '.pcx-current{display:grid;grid-template-columns:8px minmax(0,1fr);gap:12px;margin:13px 0 0;padding:14px 16px;border:1px solid #dce9e2;border-radius:18px;background:#f1f7f4;box-shadow:inset 3px 0 0 var(--pci-green)}.pcx-current-dot{width:8px;height:8px;margin-top:4px;border-radius:999px;background:var(--pci-green);box-shadow:0 0 0 5px rgba(35,101,79,.09)}.pcx-current-sentence{max-width:520px;margin-top:5px;font-size:17px;font-weight:720;line-height:1.3;letter-spacing:-.02em}',
      '.pcx-band{padding:15px 0;border-top:1px solid var(--pci-line)}.pcx-current+.pcx-next-band{border-top:0}.pcx-next-band{padding-top:13px}.pcx-next-band>.pcx-section-label{color:var(--pci-ink);font-size:9px}.pcx-next-band.is-empty{padding:11px 0 12px}.pcx-relationship-band{padding-top:14px}.pcx-band-head{display:flex;align-items:center;justify-content:space-between;gap:16px;margin-bottom:9px}.pcx-band-title{margin-top:5px;font-size:14px;font-weight:650;letter-spacing:-.01em}.pcx-band-copy{margin-top:7px;font-size:11px;line-height:1.45;color:var(--pci-muted)}.pcx-signal-pill{display:inline-flex;align-items:center;min-height:26px;border-radius:999px;background:#f0f3ef;padding:0 10px;font-size:9.5px;font-weight:650;color:#52635a;white-space:nowrap}',
      '.pcx-facts{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:0 24px!important;margin-top:8px!important;border:0!important;border-radius:0!important;background:transparent!important;box-shadow:none!important;overflow:visible!important}.pcx-fact{min-width:0!important;padding:9px 0 10px!important;border:0!important;border-top:1px solid var(--pci-soft)!important;border-radius:0!important;background:transparent!important;box-shadow:none!important}.pcx-fact span{display:block;font-size:9.5px;line-height:1.3;color:#96938c}.pcx-fact b{display:block;margin-top:3px;font-size:14px;font-weight:700;line-height:1.3;letter-spacing:-.01em;overflow-wrap:anywhere}',
      ...
      '.pcx-moveout .pcx-band-head{align-items:flex-start;margin-bottom:0}.pcx-moveout-start,.pcx-moveout-link,.pcx-moveout-cancel,.pcx-moveout-confirm{appearance:none;min-height:36px;border-radius:999px;padding:8px 14px;font-family:inherit;font-size:10.5px;font-weight:700;cursor:pointer}.pcx-moveout-start,.pcx-moveout-link,.pcx-moveout-cancel{border:1px solid var(--pci-line);background:#fff;color:var(--pci-ink)}.pcx-moveout-confirm{border:1px solid var(--pci-ink);background:var(--pci-ink);color:#fff}.pcx-moveout-state{display:inline-flex;align-items:center;min-height:26px;border-radius:999px;background:var(--pci-green-soft);padding:0 10px;font-size:9.5px;font-weight:700;color:var(--pci-green)}.pcx-moveout-copy{max-width:440px;margin-top:8px;font-size:11.5px;line-height:1.5;color:var(--pci-muted)}.pcx-moveout-link{margin-top:12px}.pcx-moveout-warning{display:grid;gap:3px;margin-top:10px;border-left:3px solid var(--pci-amber);background:#fbf7ed;padding:11px 12px}.pcx-moveout-warning b{font-size:12px}.pcx-moveout-warning span{font-size:11px;line-height:1.45;color:var(--pci-muted)}.pcx-moveout-form{display:grid;gap:10px;margin-top:12px}.pcx-moveout-form label{display:grid;gap:6px}.pcx-moveout-form label>span{display:flex;align-items:baseline;justify-content:space-between;gap:12px;font-size:10.5px;font-weight:700}.pcx-moveout-form small{font-size:9px;font-weight:500;color:var(--pci-faint)}.pcx-moveout-form input,.pcx-moveout-form textarea{width:100%;border:1px solid var(--pci-line);border-radius:8px;background:#fff;padding:9px 10px;color:var(--pci-ink);font:inherit;font-size:12px;line-height:1.4}.pcx-moveout-form textarea{resize:vertical;min-height:62px}.pcx-moveout-actions{display:flex;justify-content:flex-end;gap:8px;margin-top:12px}.pcx-moveout-actions button:disabled{opacity:.55;cursor:default}.pcx-moveout-error{margin-top:10px;border:1px solid #e8c8c2;border-radius:8px;background:var(--pci-red-soft);padding:9px 10px;color:var(--pci-red);font-size:11px;line-height:1.4}',
